...
def HourBid():
    ...
    Data_H_D['Quantity']=Data_H_D['Quantity'].round()
    Data_H_D['price']=Data_H_D['price'].round()

    Data_H_SP['Quantity']=Data_H_SP['Quantity'].round()
    Data_H_SP['price']=Data_H_SP['price'].round()
...
def Pair(postion,Hour,DF,QP):
    ...
    if QP == 'DQ':
        ...
        if postion <= (HIndex_D[Hour-1][-1]-HIndex_D[Hour-1][0]):
    ...
    if QP == 'SQ':
        ...
        if postion <= (HIndex_S[Hour-1][-1]-HIndex_S[Hour-1][0]):
